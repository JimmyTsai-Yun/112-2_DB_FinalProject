...
BEGIN
    ...
    INTO short_array
    FROM (SELECT price FROM target_company_stock_prices WHERE company = 'WMT' ORDER BY timestamp ASC) AS subquery;
    ...
    FOR i IN 1..array_length(companies, 1) LOOP
        ...
        LOOP
            -- 打印結果
            INSERT INTO wmt_euclidean_results (company, min_dis)
